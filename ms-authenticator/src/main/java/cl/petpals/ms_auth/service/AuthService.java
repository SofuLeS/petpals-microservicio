...
public class AuthService {
    ...
    public AuthResponseDto registrar(AuthRequestDto dto) {
        ...
        Rol rol;
        try {
            rol = Rol.valueOf(dto.getRol() != null ? dto.getRol().toUpperCase() : "DUENO");
        } catch (IllegalArgumentException e) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Rol inválido. Valores permitidos: ADMIN, DUENO, CUIDADOR");
        }
